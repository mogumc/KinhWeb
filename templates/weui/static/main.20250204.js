    ...
    fetch(apiUrl)
        ...
        .then(jsonData => {
            ...
            const html = `
                <div class="weui-flex__item" style="display: inline-block; margin-right: 5px;">
                    <div class="placeholder">
                        <a href="javascript:openDir('${encodeURIComponent(currentPath)}');" role="button" class="weui-btn weui-btn_mini weui-btn_default weui-wa-hotarea" title="${part}">${part}...</a>
                    </div>
                </div>
            `;
                    ...
                    <div class="weui-panel__bd">
                        <a aria-labelledby="js_p1m1_bd" href="${clickCommend}" class="weui-media-box weui-media-box_appmsg">
                            <div role="option" class="weui-media-box_text">
                                ...
                                <p class="weui-media-box__desc">${fileCateText} 文件大小: ${fileSize} 创建时间: ${creationTime} 点击打开文件夹</p>
                            </div>
                        </a>
